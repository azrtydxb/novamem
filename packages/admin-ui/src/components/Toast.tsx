...
const TONE: Record<Tone, string> = {
  success: "border-graph/40 bg-graph-soft/80",
  warning: "border-warn/40 bg-warn-soft/80",
  danger: "border-err/40 bg-err-soft/80",
  info: "border-accent/40 bg-accent-soft/80",
};
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {t.description ? (
                    <div className="text-xs text-dim mt-0.5 break-words">
                      {t.description}
                    </div>
                  ) : null}
                </div>
