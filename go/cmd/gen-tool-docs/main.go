...
// docs/api/mcp-tools.md from tooldefs.json.
//
// That page used to carry a hand-written table: one paraphrase per tool,
// of a description that already existed canonically in tooldefs.json.
