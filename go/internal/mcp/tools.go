...
// tooldefs.json is generated by cmd/gen-contract from api/openapi.yaml:
// the tool surface is the `x-mcp-tool` extension on the operation each
// tool backs, so a tool cannot exist without a route to serve it. Do not
// edit the JSON — the next regeneration overwrites it.
//
